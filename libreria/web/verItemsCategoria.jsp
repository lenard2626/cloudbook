       ...
       <div class="row">
          <div class="large-12 columns">
            <ul class="breadcrumbs">
                <li><a href="index.jsp">Inicio</a></li>
                <li><a href="Catalogo">Catalogo</a></li>
                <li class="current">Items categoria: <%= item.getNombre()%>  </li>
            </ul>
          </div> 
       </div>   
      <div class="row">
          ...
          <div class="section-container tabs" data-section>
            ...
            <section class="section">
              ...
              <ol>
                  ...
                  <li><a href="VerItem?idItem=<%= lista.getIdItem() %>&id=<%= item.getIdCategoria()%>"> Autor: <%= lista.getAutor() %>, Titulo: <%= lista.getTitulo() %> </a> </li>
                  <% } %>
